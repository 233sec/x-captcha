...
Route::get('/recaptcha/api2/worker.js', '\App\Http\Controllers\Frontend\CaptchaController@pow')->name('frontend.captcha.pow');                                    # POW.js
Route::get('/recaptcha/api2/api.js', '\App\Http\Controllers\Frontend\CaptchaController@apiJs')->name('frontend.captcha.loader');                               # API.js
...
Route::get('/recaptcha/api2/fallback.css', '\App\Http\Controllers\Frontend\CaptchaController@fallbackCss')->name('frontend.captcha.fallback.css');             # 回落验证 点击后出现的页面
Route::get('/recaptcha/api2/image', '\App\Http\Controllers\Frontend\CaptchaController@fallimage')->name('frontend.captcha.fallimg');                           # 回落验证 点击后出现的页面
Route::get('/recaptcha/api2/r20170315121834/fallback_zh_cn.js', '\App\Http\Controllers\Frontend\CaptchaController@falljs')->name('frontend.captcha.falljs');    # JS
